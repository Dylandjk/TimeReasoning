...
if __name__ == "__main__":
    ...
    # 设置查询语句
    sparql.setQuery("""
    SELECT ?item ?itemLabelZh ?itemLabelEn  ?startTime ?endTime 
    WHERE {
        VALUES ?type {wd:Q10869653 wd:Q170584 wd:Q15275719 wd:Q1190554 wd:Q1656682 wd:Q2245405 wd:Q13418847 }
    ?item
        wdt:P31 ?type;         # 词条类型是 creation,project,recurring event,occurrence,event,key event,historical event
    ...
    # 将结果写入文件
    with open("wikidata_results1.json", "w", encoding="utf8") as f:
