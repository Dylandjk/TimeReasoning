...
if __name__ == "__main__":
    ...
    # 设置查询语句
    sparql.setQuery("""
    SELECT ?item ?itemLabelZh ?itemLabelEn   ?point_in_time ?type
    WHERE {
        VALUES ?type {wd:Q10869653 wd:Q170584 wd:Q15275719 wd:Q1190554 wd:Q1656682 wd:Q2245405}
        ?item 
        wdt:P31 ?type;         # 词条类型是 creation,project,recurring event,occurrence,event,key event
        wdt:P585 ?point_in_time.      # 具有时间点属性
    ...
    FILTER (?point_in_time >= "1900-01-01T00:00:00Z"^^xsd:dateTime && ?point_in_time <= "2010-12-31T23:59:59Z"^^xsd:dateTime)
    ...
    # 将结果写入文件
    with open("wikidata_results2.json", "w", encoding="utf8") as f:
